...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function installUngroupedStyle() {
        ...
        style.textContent = '[data-timestamp-ungrouped]{font-style:italic;border:1px dashed var(--dsw-alias-border-l3);border-radius:12px;margin:0;padding:2px}' + '[data-timestamp-ungrouped] [class*="folder"]{position:relative;display:inline-flex;align-items:center;justify-content:center}' + '[data-timestamp-ungrouped] [class*="folder"] svg{display:none!important}' + '[data-timestamp-ungrouped] [class*="folder"]::after{content:"⚡";font-size:14px;line-height:1}';
