...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function HeroFlow(props) {
        ...
        return React.createElement('div', { style: { display: 'flex', alignItems: 'center', gap: 8, margin: '8px 0' } }, React.createElement('button', {
            type: 'button',
            onClick: () => autoCreateAndStart(props.workspaces ?? runtime?.workspaces, runtime?.sessions, props.root),
