...
function installWorkspaceLabelOverride(slots) {
	...
	entry.component = (props) => React.createElement(nativeWorkspaceBrowserOriginal, {
		...props,
		t: (key) => key === "group.ungrouped" ? "临时对话" : props.t(key)
	});
}
