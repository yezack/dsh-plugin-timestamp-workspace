...
function moveUngroupedFirst(node) {
	...
	if (children !== void 0 && children !== null) return React.cloneElement(node, props, Array.isArray(children) ? children.map(moveUngroupedFirst) : moveUngroupedFirst(children));
	return node;
}
